...
// Modal slider yapılandırması
    document.addEventListener('DOMContentLoaded', function() {
        const initModalSliders = function() {
        ...
        // Modallar açıldığında Swiper'ı yeniden başlat
        const modalLinks = document.querySelectorAll('.folio-list__item-link, .folio-list__proj-link');
        modalLinks.forEach(link => {
            link.addEventListener('click', function() {
                setTimeout(initModalSliders, 100);
            });
        });
    });
